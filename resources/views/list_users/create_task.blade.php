    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading" align="center"><strong>Create Task</strong></div>
                ...
                <div class="panel-body">
                 <form class="form-horizontal" role="form" method="POST" action="{{url('create-task', [$user->id])}}">
                        {{ csrf_field() }}
                   ...
                   <div class="form-group">
                    ...
                    <textarea class="form-control" rows="4" id="comment" name="task"></textarea>
                    ...
                    <input type="date" data-date="" data-date-format="DD MMMM YYYY" value="2017-01-01" name="date">
                   </div>
